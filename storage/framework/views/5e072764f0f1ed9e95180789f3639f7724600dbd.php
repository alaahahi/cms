                ...
                <div class="col-md-8">
                    <div class="panel panel-bordered">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="phone"><?php echo e(__('voyager::generic.phone')); ?></label>
                                <input type="phone" class="form-control" id="phone" name="phone" placeholder="<?php echo e(__('voyager::generic.phone')); ?>"
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cms\resources\views/vendor/voyager/users/edit-add.blade.php ENDPATH**/ ?>