            ...
            <table class="table table-bordered data-table1">
                <thead>
                    ...
                    <th><?php echo e(__('voyager::generic.full_name')); ?></th>
                        ...
                        <th><?php echo e(__('voyager::generic.card_number')); ?></th>
...
<script type="text/javascript">
  $(function () {
    ...
    $('body').on('click', '.add', function () { 
        ...
        $.ajax({
            ...
            success: function (client) {
                ...
                $.ajax({
                type: "GET",
                url:"<?php echo e(route('card_service')); ?>/"+q ,
                ...
                table = $('.data-table').DataTable({
                            ajax: "<?php echo e(route('check_card')); ?>/"+q ,
                                    columns: [
    ...
    $.ajax({
            type: "GET",
            url:"<?php echo e(route('submit_service')); ?>/"+Item_client+"/"+Item_services,
            success: function (client) {
    ...
    {
    var q = $('#card_number_input').val();
    window.location.href = "<?php echo e(route('generatePDF_card')); ?>/"+q ;
    });
    ...
    table = $('.data-table1').DataTable({
                            ajax: "<?php echo e(route('cards_from_to')); ?>/"+from+"/"+to+"/"+type+"/"+false,
                                    columns: [
    ...
    if (from == "") from =0;
    if (to == "") to = 0;
    window.location.href =  "<?php echo e(route('cards_from_to')); ?>/"+from+"/"+to+"/"+type+"/"+true ;
    });
});
</script>
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cms\resources\views/report/card.blade.php ENDPATH**/ ?>