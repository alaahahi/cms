        ...
        <div class="col-md-12 mt-5">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3><strong><?php echo e(__('voyager::generic.client')); ?></strong></h3>
                </div>
            </div>
             <a href="javascript:void(0)" class="btn btn-primary add"><?php echo e(__('voyager::generic.new_client')); ?></a>
            ...
            <div class="row">
                <div class="col-md-6 text-center">           
                    <div class="form-group">
                        <label for="totaltody"><?php echo e(__('voyager::generic.client_today')); ?></label>
                        <?php $total = 0;$count =0 ?>
            ...
            <table class="table table-bordered data-table">
                <thead>
                    <tr>
                        <th>No</th>
                        <th><?php echo e(__('voyager::generic.full_name')); ?></th>
                        <th><?php echo e(__('voyager::generic.phone')); ?></th>
                        <th><?php echo e(__('voyager::generic.strat_active')); ?></th>
                        <th><?php echo e(__('voyager::generic.end_active')); ?></th>
                        <th><?php echo e(__('voyager::generic.card_type')); ?></th>
...
<div class="modal fade modal-product" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <div class="row">
        <div class="col-md-6">
            <h4 class="modal-title" id="exampleModalLabel"><?php echo e(__('voyager::generic.new_client')); ?></h4>
        </div>
        <div class="col-md-6">
      ...
      <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                <label for="birth_date" class="col-form-label"><?php echo e(__('voyager::generic.birth_date')); ?>:</label>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cms\resources\views/clients.blade.php ENDPATH**/ ?>